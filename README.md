...
**1.0.12 요약:** 감사 반영 안정화(CSV BOM, 메시징 재시도, 시간 범위 export, multi-tab 안내 등) + SOLID 모듈 분할(orchestrator / pipeline / public-api / history detail). 공개 동작·import 경로는 호환 유지. 자세한 항목은 [DEPLOYMENT.md §11](DEPLOYMENT.md#11-릴리스-노트).
