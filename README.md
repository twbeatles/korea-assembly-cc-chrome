...
**1.0.14 요약:** 페이지 패널에서 수집 시작·종료, TXT 우선 내보내기, 팝업 상태·피드백 분리, 설정 변경 저장 상태 표시를 추가했습니다. 자세한 항목은 [DEPLOYMENT.md §11](DEPLOYMENT.md#11-릴리스-노트).
...
- **우측 패널** — 수집 시작·종료, 실시간 미리보기 + 수집된 자막 목록, 복사·저장·내보내기
...
패널·팝업에서 바로 내보낼 수 있습니다. 패널에서는 **TXT 저장**을 기본 행동으로 먼저 보여 주며, 다른 형식은 「다른 형식 선택」에서 고릅니다.
